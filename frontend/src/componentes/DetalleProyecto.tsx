...
import { FaArrowLeft, FaFileUpload, FaDownload } from 'react-icons/fa';
...
import { obtenerDocumentosPorProyecto, subirDocumento } from '../servicios/documentos.servicio';
import { 
...
import { Proyecto, Documento, Observacion, Correccion, Rol } from '../tipos/usuario';
...
const DetalleProyecto = () => {
  ...
  const cargarDatos = async () => {
    try {
      ...
      const documentosData = await obtenerDocumentosPorProyecto(parseInt(id!));
